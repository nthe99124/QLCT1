...
Viva.Graph = {
  ...
  Layout: {
    ...
    DataType: require('./Layout/DataType.js')
  },
 ...
 */
function DataType(graph, userSettings) {
    ...
    return {
         ...
         *  The DataType layout ignores this parameter.
         */
