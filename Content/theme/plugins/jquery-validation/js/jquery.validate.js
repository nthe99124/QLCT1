    ...
    a.extend(a.fn, {
        ...
        prototype: {
            init: function () {
                ...
                }), a(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'],[type='special'],[type='floatNumber'],[type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox']", "focusin focusout keyup", b).validateDelegate("select, option, [type='radio'], [type='checkbox']", "click", b), this.settings.invalidHandler && a(this.currentForm).bind("invalid-form.validate", this.settings.invalidHandler), a(this.currentForm).find("[required], [data-rule-required], .required").attr("aria-required", "true")
            }, form: function () {
        ...
        attributeRules: function (b) {
            ...
            for (c in a.validator.methods) "required" === c ? (d = b.getAttribute(c), "" === d && (d = !0), d = !!d) : d = f.attr(c), /min|max/.test(c) && (null === g || /number|range|text|special|floatNumber/.test(g)) && (d = Number(d)), d || 0 === d ? e[c] = d : g === c && "range" !== g && (e[c] = !0);
        ...
        methods: {
            ...
            /*ToiLDA add new function for check only number and text*/
            special: function (a, b) {
                return this.optional(b) || /^[a-zA-Z0-9]\s!@#$%^&*$/.test(a);
            },
            floatNumber: function(a, b) {
